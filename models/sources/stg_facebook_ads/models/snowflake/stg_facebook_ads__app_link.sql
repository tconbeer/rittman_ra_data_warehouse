            ...
            with
                ...
                required_fields as (
                    ...
                    select
                        ...
                        ) as template_app_link_spec_ios,
                        parse_json(
                            template_app_link_spec_ipad
                        ) as template_app_link_spec_ipad,
                        parse_json(
                            template_app_link_spec_android
                        ) as template_app_link_spec_android,
                        parse_json(
                            template_app_link_spec_iphone
                        ) as template_app_link_spec_iphone
                    from base
                ...
                {% for app in ["ios", "ipad", "android", "iphone"] %}
                    ...
                    flattened_{{ app }} as (
                        ...
                        from
                            required_fields,
                            lateral flatten(
                                input => template_app_link_spec_{{ app }}
                            ) as element
                ...
                unioned as (
                    ...
                    union all
                    select *
                    from flattened_iphone
                    union all
                    select *
                    from flattened_ipad
                    union all
                    select *
                    from flattened_android
