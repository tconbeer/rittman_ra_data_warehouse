...
{% if var("crm_warehouse_contact_sources") and var(
    "marketing_warehouse_deal_sources"
) %}
    {% if "hubspot_crm" in var(
        "crm_warehouse_contact_sources"
    ) and "hubspot_crm" in var("marketing_warehouse_deal_sources") %}
                ...
                renamed as (
                    select
                        ...
                        concat(
                            ...
                            associations:associatedvids:value::int
                        ) as contact_id
                    from source
                )
        {% endif %}
