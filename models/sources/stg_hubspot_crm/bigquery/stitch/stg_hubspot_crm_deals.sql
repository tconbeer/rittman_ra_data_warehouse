                    ...
                    source as (
                        {{
                            filter_stitch_relation(
                                relation=source("stitch_hubspot_crm", "deals"),
                    ...
                    renamed as (
                        select
                            ...
                            concat(
                                ...
                                cast(associatedcompanyids.value as string)
                            ) as company_id,
                            property_dealname.value as deal_name,
                            case
                                when property_dealtype.value = 'newbusiness'
                                then 'New Business'
                                when property_dealtype.value = 'existingbusiness'
                            ...
                            timestamp_millis(
                                safe_cast(
                                    property_delivery_schedule_date.value as int64
                                )
                            ) as delivery_schedule_ts,
                            timestamp_millis(
                                safe_cast(property_delivery_start_date.value as int64)
                            ...
                            timestamp_millis(
                                safe_cast(property_end_date.value as int64)
                            ) as deal_end_ts,
                            property_hs_sales_email_last_replied.value
                            as deal_sales_email_last_replied,
                            property_engagements_last_meeting_booked.value
                            as deal_last_meeting_booked_date,
                            property_hs_deal_stage_probability.value
                            ...
                            property_hs_analytics_source_data_1.value
                            as hs_analytics_source_data_1,
                            property_hs_analytics_source_data_2.value
                            as hs_analytics_source_data_2,
                            property_amount.value as deal_amount,
                            property_hs_projected_amount_in_home_currency.value
                            as projected_home_currency_amount,
                            property_amount_in_home_currency.value
                            ...
                            case
                                when property_deal_components.value like '%Services%'
                                then true
                                else false
                            end as is_services_deal,
                            case
                                when
                                    property_deal_components.value
                            ...
                            case
                                when property_deal_components.value like '%Training%'
                                then true
                                else false
                            end as is_training_deal,
                            case
                                when property_deal_components.value like '%Looker%'
                                then true
                                else false
                            end as is_looker_skill_requirement,
                            case
                                when
                                    property_products_in_solution.value like '%Segment%'
                                then true
                                else false
                            end as is_segment_skill_requirement,
                            case
                                when property_products_in_solution.value like '%dbt%'
                                then true
                                else false
                            end as is_dbt_skill_requirement,
                            case
                                when property_products_in_solution.value like '%Stitch%'
                                then true
                                else false
                            end as is_stitch_skill_requirement,
                            case
                                when property_products_in_solution.value like '%GCP%'
                                then true
                                else false
                            end as is_gcp_skill_requirement,
                            case
                                when
                                    property_products_in_solution.value
                                    like '%Snowflake%'
                                then true
                                else false
                            end as is_snowflake_skill_requirement,
                            case
                                when property_products_in_solution.value like '%Qubit%'
                                then true
                                else false
                            ...
                            property_hs_date_entered_1164152.value
                            as date_entered_deal_stage_1,
                            property_hs_date_exited_1164152.value
                            as date_exited_deal_stage_1,
                            round(
                                cast(property_hs_time_in_1164152.value as int64)
                                / 3600000
                                / 24,
                                0
                            ) as days_in_deal_stage_1,
                            property_hs_date_entered_qualifiedtobuy.value
                            as date_entered_deal_stage_2,
                            property_hs_date_exited_qualifiedtobuy.value
                            as date_exited_deal_stage_2,
                            round(
                                cast(property_hs_time_in_qualifiedtobuy.value as int64)
                                / 3600000
                                / 24,
                                0
                            ) as days_in_deal_stage_2,
                            property_hs_date_entered_1357010.value
                            as date_entered_deal_stage_3,
                            property_hs_date_exited_1357010.value
                            as date_exited_deal_stage_3,
                            round(
                                cast(property_hs_time_in_1357010.value as int64)
                                / 3600000
                                / 24,
                                0
                            ) as days_in_deal_stage_3,
                            property_hs_date_entered_presentationscheduled.value
                            as date_entered_deal_stage_4,
                            property_hs_date_exited_presentationscheduled.value
                            as date_exited_deal_stage_4,
                            round(
                                cast(
                                    property_hs_time_in_presentationscheduled.value
                                    as int64
                                )
                                / 3600000
                                / 24,
                            ...
                            property_hs_date_entered_1164140.value
                            as date_entered_deal_stage_5,
                            property_hs_date_exited_1164140.value
                            as date_exited_deal_stage_5,
                            round(
                                cast(property_hs_time_in_1164140.value as int64)
                                / 3600000
                                / 24,
                                0
                            ) as days_in_deal_stage_5,
                            property_hs_date_entered_553a886b_24bc_4ec4_bca3_b1b7fcd9e1c7_1321074272.value
                            as date_entered_deal_stage_6,
                            property_hs_date_exited_553a886b_24bc_4ec4_bca3_b1b7fcd9e1c7_1321074272.value
                            as date_exited_deal_stage_6,
                            round(
                                cast(
                            ...
                            as date_entered_deal_stage_7,
                            property_hs_date_exited_7c41062e_06c6_4a4a_87eb_de503061b23c_975176047.value
                            as date_exited_deal_stage_7,
                            round(
                                cast(
                            ...
                            property_hs_date_entered_1031924.value
                            as date_entered_deal_stage_8,
                            round(
                                cast(property_hs_time_in_1031924.value as int64)
                                / 3600000
                                / 24,
                                0
                            ) as days_in_deal_stage_8,
                            property_hs_date_entered_1031923.value
                            as date_entered_deal_stage_9,
                            round(
                                cast(property_hs_time_in_1031923.value as int64)
                                / 3600000
                                / 24,
                                0
                            ) as days_in_deal_stage_9,
                            property_hs_date_entered_closedlost.value
                            as date_entered_deal_stage_10,
                            round(
                                cast(property_hs_time_in_closedlost.value as int64)
                                / 3600000
                                / 24,
                                0
                            ) as days_in_deal_stage_10,
                            property_hs_manual_forecast_category.value
                            as manual_forecast_category,
                            property_hs_forecast_probability.value
