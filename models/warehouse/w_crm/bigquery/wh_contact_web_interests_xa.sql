        ...
        base_scores as (
            select
                *,
                case
                    when
                        event_details like '%Attribution%'
                        or page_url like '%attribution%'
                    then 1
                ...
                case
                    when event_details like '%Pricing%' or page_url like '%pricing%'
                    then 1
                end as count_pricing,
                case
                    when event_details like '%Looker%' or page_url like '%looker%'
                    then 1
                end as count_looker,
                case
                ...
                case
                    when event_details like '%Segment%' or page_url like '%segment%'
                    then 1
                ...
                case
                    when
                        event_details like '%Google BigQuery%'
                        or page_url like '%bigquery%'
                    then 1
        ...
        weighted_scores as (
            select
                ...
                * multiplier as weighted_count_marketing_analytics,
                ...
                count_modern_data_stack
                * multiplier as weighted_count_modern_data_stack,
