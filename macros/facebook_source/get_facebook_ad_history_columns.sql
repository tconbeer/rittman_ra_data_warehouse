{% macro get_facebook_ad_history_columns() %}
    ...
    {% set columns = [
        ...
        {
            "name": "global_discriminatory_practices",
            "datatype": dbt_utils.type_string(),
        },
        {
            "name": "global_non_functional_landing_page",
            "datatype": dbt_utils.type_string(),
        },
        {
            "name": "global_use_of_our_brand_assets",
            "datatype": dbt_utils.type_string(),
        },
        ...
        {
            "name": "placement_specific_facebook_discriminatory_practices",
            "datatype": dbt_utils.type_string(),
        },
        {
            "name": "placement_specific_facebook_non_functional_landing_page",
            "datatype": dbt_utils.type_string(),
        },
        {
            "name": "placement_specific_facebook_use_of_our_brand_assets",
            "datatype": dbt_utils.type_string(),
        },
        {
            "name": "placement_specific_instagram_discriminatory_practices",
            "datatype": dbt_utils.type_string(),
        },
